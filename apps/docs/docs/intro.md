...
- **최신 기술 스택** - React 19, Vite 6, TypeScript 5 기반
- **통합 개발 환경** - ESLint 9, Prettier 3, Vitest 2 사전 구성
...
| 템플릿 | 기술 스택 | 용도 |
|--------|-----------|------|
| **[App](/docs/templates/app)** | React 19 + Chakra UI 3 + React Router 7 | 일반 웹 애플리케이션 |
| **[Admin](/docs/templates/admin)** | React 18 + Ant Design 5 + React Router 7 | 관리자 대시보드 |
| **[Library](/docs/templates/lib)** | React 18+ + Vite library mode | 컴포넌트 라이브러리 개발 |
...
다음 단계: [설치 가이드](/docs/getting-started/installation)에서 자세한 설정 방법을 확인하세요.
